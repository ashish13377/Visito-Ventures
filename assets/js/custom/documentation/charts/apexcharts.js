...
var KTGeneralApexCharts = {
	init: function () {
		var e, t, a, s, i, o, r;
		e = document.getElementById("kt_apexcharts_1"), t = parseInt(KTUtil.css(e, "height")), a = KTUtil.getCssVariableValue("--bs-gray-500"), s = KTUtil.getCssVariableValue("--bs-gray-200"), i = KTUtil.getCssVariableValue("--bs-primary"), o = KTUtil.getCssVariableValue("--bs-gray-300"), r = KTUtil.getCssVariableValue("--bs-danger"), e && new ApexCharts(e, {
				series: [{
					name: "Net Profit",
