...
function _typeof(e) {
						...
						for (var s in r)
							if (hasOwnProperty.call(r, s)) {
								for (var l, c = r[s], u = c.positions, h = 0; u[h]; h++)
									if ((l = u[h]).active) l.rendered || (i.appendChild(l.element), l.rendered = !0);
	...
	t.prototype.removeText = function (e, t, i, n, o, a) {
		...
		for (var t in e)
			if (hasOwnProperty.call(e, t))
				for (var i = this.getSVGLayer(t); i.firstChild;) i.removeChild(i.firstChild);
		this._textCache = {}
...
function (e) {
	...
	function i(t) {
		var i, n = [],
			o = e.plot.saturated.saturate(e.plot.saturated.floorInBase(t.min, t.tickSize)),
			a = 0,
			r = Number.NaN;
	...
	function r(o, a, r, s) {
		...
		w.setData = C, w.setupGrid = R, w.draw = G, w.getPlaceholder = function () {
			...
			for (t = 0; t < g.length; ++t)
				if ((i = g[t]) && i.used && (null == e[n = "x" + i.n] && 1 === i.n && (n = "x"), null != e[n])) {
					o.left = i.p2c(e[n]);
					break
				}
			for (t = 0; t < m.length; ++t)
				if ((i = m[t]) && i.used && (null == e[n = "y" + i.n] && 1 === i.n && (n = "y"), null != e[n])) {
					o.top = i.p2c(e[n]);
					break
				}
			return o
		...
		function C(t) {
			...
			l = function (t) {
				...
				function (t) {
					var i, n, o, a, r, s, c, u, h, p, d, f, g = Number.POSITIVE_INFINITY,
					...
					for (e.each(L(), (function (e, t) {
						...
						})), i = 0; i < l.length; ++i)(r = l[i]).datapoints = {
						points: []
					}, 0 === r.datapoints.points.length && (r.datapoints.points = x(t, i)), P(y.processRawData, [r, r.data, r.datapoints]);
					for (i = 0; i < l.length; ++i) {
						...
						if (r.xaxis.used = r.yaxis.used = !0, null == r.datapoints.pointsize) {
							for (r.datapoints.pointsize = f.length, c = r.datapoints.pointsize, s = r.datapoints.points, n = o = 0; n < d.length; ++n, o += c) {
								var b = null == (p = d[n]);
								if (!b)
									for (a = 0; a < c; ++a) u = p[a], (h = f[a]) && (h.number && null != u && (u = +u, isNaN(u) && (u = null)), null == u && (h.required && (b = !0), null != h.defaultValue && (u = h.defaultValue))), s[o + a] = u;
								if (b)
									for (a = 0; a < c; ++a) null != (u = s[o + a]) && (h = f[a]).computeRange && (h.x && v(r.xaxis, u, u), h.y && v(r.yaxis, u, u)), s[o + a] = null
							}
							s.length = o
						}
					}
					...
					for (i = 0; i < l.length; ++i)
						if (!(f = (r = l[i]).datapoints.format).every((function (e) {
		...
		function O(t) {
			...
			var n, o, a = t.options.transform || i,
		...
		function R(t) {
			...
			if (e.each(r, (function (i, o) {
					...
					o.show = null == s.show ? o.used : s.show, o.reserveSpace = null == s.reserveSpace ? o.show : s.reserveSpace, r = (a = o).options, a.tickFormatter || ("function" == typeof r.tickFormatter ? a.tickFormatter = function () {
						...
						} : a.tickFormatter = n), P(y.setRange, [o, t]),
						function (t, i) {
				...
				for (e.each(h, (function (t, n) {
						...
						function (t) {
							...
							})) && (o.min = Math.min(o.min, a[0].v), o.max = Math.max(o.max, a[a.length - 1].v)), O(n),
							function (e, t) {
								...
								return 0 === i.length || n
							}(s = n, l) && (s.ticks.unshift(X(s.min, null, s, "min")), s.ticks.push(X(s.max, null, s, "max"))),
							function (e) {
				...
				! function () {
					...
					if (null == i)
						for (t = i = 0; t < l.length; ++t) i = Math.max(i, 2 * (l[t].points.radius + l[t].points.lineWidth / 2));
					var n, o = {},
						a = {
							left: i,
							right: i,
		...
		function D(t, i, n, o, a) {
			...
			return 2.25 < c && c < 3 && l + 1 <= a && ++l, isFinite(l) ? l : 0
		}
		...
		function B(e, t) {
			for (var i, n, o, a, r = L(), s = 0; s < r.length; ++s)
				if ((i = r[s]).direction === t && (e[a = t + i.n + "axis"] || 1 !== i.n || (a = t + "axis"), e[a])) {
					n = e[a].from, o = e[a].to;
					break
				}
		...
		function Q() {
			var t, i, n, o;
			d.save(), d.translate(v.left, v.top),
				function () {
					var t, i, n = c.grid.markings;
					if (n)
						for (e.isFunction(n) && ((t = w.getAxes()).xmin = t.xaxis.min, t.xmax = t.xaxis.max, t.ymin = t.yaxis.min, t.ymax = t.yaxis.max, n = n(t)), i = 0; i < n.length; ++i) {
							var o = n[i],
								a = B(o, "x"),
								r = B(o, "y");
							if (null == a.from && (a.from = a.axis.min), null == a.to && (a.to = a.axis.max), null == r.from && (r.from = r.axis.min), null == r.to && (r.to = r.axis.max), !(a.to < a.axis.min || a.from > a.axis.max || r.to < r.axis.min || r.from > r.axis.max)) {
								...
								var s = a.from === a.to,
									l = r.from === r.to;
								if (!s || !l)
									if (a.from = Math.floor(a.axis.p2c(a.from)), a.to = Math.floor(a.axis.p2c(a.to)), r.from = Math.floor(r.axis.p2c(r.from)), r.to = Math.floor(r.axis.p2c(r.to)), s || l) {
		...
		function K(e, t, i) {
			var n, o, a = e.bars.barWidth[0] || e.bars.barWidth,
				r = e.xaxis.c2p(t),
				s = e.yaxis.c2p(i),
		...
		function $() {
			var e = c.interaction.redrawOverlayInterval; - 1 !== e ? T || (T = setTimeout((function () {
				ee(w)
			}), e)) : ee()
		}
		...
		function (t) {
			...
			for (var u in e.each(L(), (function (e, t) {
					t.boxPosition = t.options.boxPosition || {
						centerX: 0,
						centerY: 0
					}
...
function (e) {
	e.plot.drawSeries = new function () {
		...
		this.drawSeriesLines = function (e, t, n, o, a, r, s) {
			...
			u && (t.fillStyle = u, function (e, t, i, n, o, a) {
				for (var r = e.points, s = e.pointsize, l = n > i.min ? Math.min(i.max, n) : i.min, c = 0, u = 1, h = !1, p = 0, d = 0, f = null, g = null; !(0 < s && c > r.length + s);) {
					...
					if (null != m && null != x) {
						...
						if (h || (o.beginPath(), o.moveTo(t.p2c(m), i.p2c(l)), h = !0), v >= i.max && b >= i.max) o.lineTo(t.p2c(m), i.p2c(i.max)), o.lineTo(t.p2c(x), i.p2c(i.max));
						else if (v <= i.min && b <= i.min) o.lineTo(t.p2c(m), i.p2c(i.min)), o.lineTo(t.p2c(x), i.p2c(i.min));
						else {
							var y = m,
								w = x;
				...
				for (a.beginPath(), v = l; v < s.length; v += l)
					if (h = s[v - l], p = s[v - l + 1], d = s[v], f = s[v + 1], null !== h && null !== d)
						if (isNaN(h) || isNaN(d) || isNaN(p) || isNaN(f)) u = c = null;
						else {
			...
			var u, h = e.points.lineWidth,
				p = e.points.radius,
				d = e.points.symbol;
			"circle" === d ? u = l : "string" == typeof d && r && r[d] ? u = r[d] : "function" == typeof r && (u = r), 0 === h && (h = 1e-4), t.lineWidth = h, t.fillStyle = i(e.points, e.color, null, null, s), t.strokeStyle = e.color,
			...
			switch (e.bars.align) {
				...
				for (var c = i.points, u = i.pointsize, h = e.bars.fillTowards || 0, p = h > l.min ? Math.min(l.max, h) : l.min, d = 0; d < c.length; d += u)
					if (null != c[d]) {
						var f = 3 === u ? c[d + 2] : p;
...
function (e) {
	...
	function n(t, i, n, a, r, s, l, c, u, h, p) {
		a += h, r += h, s += h, "x" === i.err ? (n + u < r ? o(t, [
			...
			[n, Math.max(a + u, p[1])],
			[n, s]
		]) : c = !1), u = null != i.radius ? i.radius : u, l && ("-" === i.upperCap ? "x" === i.err ? o(t, [
			[r, a - u],
			[r, a + u]
		]) : o(t, [
			[n - u, r],
			[n + u, r]
		]) : e.isFunction(i.upperCap) && ("x" === i.err ? i.upperCap(t, r, a, u) : i.upperCap(t, n, r, u))), c && ("-" === i.lowerCap ? "x" === i.err ? o(t, [
			[s, a - u],
			[s, a + u]
		]) : o(t, [
			[n - u, s],
			[n + u, s]
		]) : e.isFunction(i.lowerCap) && ("x" === i.err ? i.lowerCap(t, s, a, u) : i.lowerCap(t, n, s, u)))
	}
	...
	function (e) {
		...
		function a(a, r) {
			...
			function x(e, t) {
				...
				if (v && T(e), a.getOptions().zoom.active) return e.preventDefault(),
					function (e, t, n) {
						var o = i.getPageXY(e),
							r = a.offset();
						...
						0 === l.length && (l = void 0), t ? a.zoomOut({
							center: r,
							axes: l,
							amount: n
						}) : a.zoom({
			...
			function k(e) {
				if (v) {
					var t = i.getPageXY(e),
						n = a.getOptions().pan.frameRate; - 1 !== n ? !g && n && (g = setTimeout((function () {
						p ? a.smartPan({
							x: s.startPageX - t.X,
							y: s.startPageY - t.Y
						}, s, l, !1, h) : u && (a.pan({
			...
			a.navigationState = function (e, t) {
				...
				e.each(t.axes || a.getAxes(), (function (e, i) {
					t.axes ? "x" === this.direction ? i.options.offset = {
						below: 0
					} : "y" === this.direction && (i.options.offset = {
						above: 0
					}) : i.options.offset = {
						below: 0,
						above: 0
			...
			a.smartPan = function (e, i, o, r, s) {
				var l, c, u, h, p, d, g, m, v, x, b, y, w, k = !!s || (c = e, Math.abs(c.y) < n && Math.abs(c.x) >= n || Math.abs(c.x) < n && Math.abs(c.y) >= n),
					T = a.getAxes();
				e = s ? function (e) {
				...
				if (f) {
					...
					var i, n, a = Math.round(f.start.x),
						r = Math.round(f.start.y);
					if (l ? "x" === l[0].direction ? (n = Math.round(f.start.y), i = Math.round(f.end.x)) : "y" === l[0].direction && (i = Math.round(f.start.x), n = Math.round(f.end.y)) : (i = Math.round(f.end.x), n = Math.round(f.end.y)), t.beginPath(), !1 === f.end) t.moveTo(a, r - o), t.lineTo(a, r + o), t.moveTo(a + o, r), t.lineTo(a - o, r);
					else {
						var s = r === n;
		...
		function n(t, n, o) {
			if ("categories" === t[n].options.mode) {
				if (!t[n].categories) {
					...
					if (e.isArray(r))
						for (var s = 0; s < r.length; ++s) a[r[s]] = s;
					else
	...
	function (e) {
		...
		function a(e) {
			var t, i, n, o, a = e.detail.touches[0],
		...
		e.plot.plugins.push({
			init: function (n) {
				...
				function d(e, t, i) {
					...
					var r = g(e, t); - 1 === r ? (a.push({
						series: e,
						point: t,
						auto: i
					}), n.triggerRedrawOverlay()) : i || (a[r].auto = !1)
				}
				...
				function f(e, t) {
					...
					var o = g(e, t); - 1 !== o && (a.splice(o, 1), n.triggerRedrawOverlay())
				}
				...
				function y(t, i, n) {
					var o, a = "string" == typeof t.highlightColor ? t.highlightColor : e.color.parse(t.color).scale("a", .5).toString(),
						r = a,
	...
	function (e) {
		function t(e, t) {
			...
			function o(t) {
				var o = e.getOptions();
				(o.pan.active || o.zoom.active) && (3 <= t.touches.length ? n.isUnsupportedGesture = !0 : n.isUnsupportedGesture = !1, i.dispatchEvent(new CustomEvent("touchevent", {
					detail: t
				})), g(t) ? a(t, "pinch") : (a(t, "pan"), f(t) || (function (e) {
			...
			var r = {
					...
					touchmove: function (e) {
						...
						p(e), h(e), t = e, n.currentTapEnd = {
							x: t.touches[0].pageX,
							y: t.touches[0].pageY
						}, n.isUnsupportedGesture || i.dispatchEvent(new CustomEvent("pandrag", {
							detail: e
						}))
					},
					touchend: function (e) {
						var t;
						p(e), f(e) ? (i.dispatchEvent(new CustomEvent("pinchend", {
							detail: e
						})), i.dispatchEvent(new CustomEvent("panstart", {
							detail: e
						}))) : (t = e).touches && 0 === t.touches.length && i.dispatchEvent(new CustomEvent("panend", {
							detail: e
						}))
					}
				},
				s = {
					...
					touchmove: function (e) {
						p(e), n.twoTouches = g(e), n.isUnsupportedGesture || i.dispatchEvent(new CustomEvent("pinchdrag", {
							detail: e
						}))
					},
					touchend: function (e) {
				...
				l = {
					onDoubleTap: function (e) {
						p(e), i.dispatchEvent(new CustomEvent("doubletap", {
							detail: e
						}))
					}
				},
				c = {
					...
					waitForLongTap: function (e) {
						n.longTapTriggerId || (n.longTapTriggerId = setTimeout((function () {
							c.isLongTap(e) && i.dispatchEvent(new CustomEvent("longtap", {
								detail: e
				...
				u = {
					...
					touchmove: function (e) {},
					touchend: function (e) {
						u.isTap(e) && (i.dispatchEvent(new CustomEvent("tap", {
							detail: e
						})), p(e))
					},
					isTap: function (e) {
	...
	function (e) {
		var t = e.plot.saturated.floorInBase,
			i = function (e, t) {
				var i = new e(t),
					n = i.setTime.bind(i);
				i.update = function (e) {
					n(e), e = Math.round(1e3 * e) / 1e3, this.microseconds = 1e3 * (e - Math.floor(e))
				};
		...
		function p(e) {
			...
			var g = d[f][0],
				m = d[f][1];
			if ("year" === m) {
				if (null !== n.minTickSize && void 0 !== n.minTickSize && "year" === n.minTickSize[1]) g = Math.floor(n.minTickSize[0]);
				else {
					var v = parseFloat("1e" + Math.floor(Math.log(e.delta / i.year) / Math.LN10)),
						x = e.delta / i.year / v;
			...
			do {
				...
				else "year" === m ? c.setFullYear(c.getFullYear() + b) : "seconds" === n.timeBase ? c.setTime(1e3 * (M + y)) : "microseconds" === n.timeBase ? c.setTime((M + y) / 1e3) : c.setTime(M + y)
			} while (M < e.max && M !== k);
			return o
		}
		e.plot.plugins.push({
					...
					e.each(t.getAxes(), (function (e, t) {
						...
						if ("time" === i.mode) {
							...
							t.tickFormatter = function (e, t) {
								...
								var c, u = t.options.tickSize && "quarter" === t.options.tickSize[1] || t.options.minTickSize && "quarter" === t.options.minTickSize[1];
								c = "seconds" === i.timeBase ? r : "microseconds" === i.timeBase ? l : s;
								var h, p, d = t.tickSize[0] * c[t.tickSize[1]],
									f = t.max - t.min,
									g = i.twelveHourClock ? " %p" : "",
									m = i.twelveHourClock ? "%I" : "%H";
								if (h = "seconds" === i.timeBase ? 1 : "microseconds" === i.timeBase ? 1e6 : 1e3, d < c.second) {
									var v = -Math.floor(Math.log10(d / h)); - 1 < String(d).indexOf("25") && v++, p = "%S.%" + v + "s"
					...
					if (n.axisLabels.show) {
						...
						i.hooks.axisReserveSpace.push((function (e, i) {
							...
							if (i.labelHeight += i.boxPosition.centerY, i.labelWidth += i.boxPosition.centerX, n && n.axisLabel && i.show) {
								var r = void 0 === n.axisLabelPadding ? 2 : n.axisLabelPadding,
									s = o[a];
		...
		e.plot.plugins.push({
			init: function (t) {
				...
				function g(e, i) {
					...
					for (var l in s)
						if ((n = s[l]).direction === i && (e[r = i + n.n + "axis"] || 1 !== n.n || (r = i + "axis"), e[r])) {
							o = e[r].from, a = e[r].to;
							break
						}
				...
				t.clearSelection = f, t.setSelection = function (e, n) {
					...
					if (i.show && m()) {
						...
						var u = Math.min(i.first.x, i.second.x) + .5,
							p = u,
							d = Math.min(i.first.y, i.second.y) + .5,
							f = d,
		...
		function o(e, o) {
			...
			return Promise.all(p).then((h = o, function (e) {
				var i = function (e, i) {
					...
					if (0 === n)
						for (var o = i.getContext("2d"), a = 0; a < e.length; a++) !0 === e[a].successfullyLoaded && o.drawImage(e[a], e[a].xCompOffset * t, e[a].yCompOffset * t);
					return n
				}(e, h);
				return i
			}), c)
	...
	function (e) {
		...
		function i(e, t) {
			for (var i in e)
				if (e.hasOwnProperty(i) && e[i] !== t[i]) return !0;
			return !1
		}
		e.plot.plugins.push({
			init: function (n) {
